//===--- GlulxOptimizeLiveIntervals.cpp - LiveInterval processing ---===//
//
...
#define DEBUG_TYPE "glulx-optimize-live-intervals"

namespace {
class GlulxOptimizeLiveIntervals final : public MachineFunctionPass {
  StringRef getPassName() const override {
    return "Glulx Optimize Live Intervals";
  }
...
public:
  ...
  GlulxOptimizeLiveIntervals() : MachineFunctionPass(ID) {}
};
} // end anonymous namespace

char GlulxOptimizeLiveIntervals::ID = 0;
INITIALIZE_PASS(GlulxOptimizeLiveIntervals, DEBUG_TYPE,
                "Optimize LiveIntervals for Glulx", false, false)

FunctionPass *llvm::createGlulxOptimizeLiveIntervals() {
  return new GlulxOptimizeLiveIntervals();
}

bool GlulxOptimizeLiveIntervals::runOnMachineFunction(
    MachineFunction &MF) {
